...
class StoreUserRequest extends FormRequest
{
        ...
        return [
            ...
            'password' => [
                ...
                Password::min(8)
                    ...
                    ->numbers()
                    ->symbols()
                    ->uncompromised(), // Não em lista de breach conhecidos
            ],
     ...
     * 
     * Hash da senha é feito aqui antes de retornar
     * 
     * @return array
     */
    public function validated(): array
    {
        ...
        // Hash da senha (Laravel faz automaticamente, mas deixamos explícito)
        // Não há necessidade pois o User model castará automaticamente
