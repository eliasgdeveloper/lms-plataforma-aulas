...
Route::prefix('admin')->middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::get('cursos/{curso}/participantes/busca', [CursoController::class, 'adminSearchParticipants'])
        ->name('admin.cursos.participantes.search');

    Route::post('cursos/{curso}/participantes/inscrever', [CursoController::class, 'adminEnrollParticipant'])
        ->name('admin.cursos.participantes.enroll');

    Route::post('cursos/{curso}/participantes/cadastrar', [CursoController::class, 'adminCreateParticipant'])
        ->name('admin.cursos.participantes.create');
